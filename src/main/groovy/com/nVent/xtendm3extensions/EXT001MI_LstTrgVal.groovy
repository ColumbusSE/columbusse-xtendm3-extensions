...
//
// Description 
// This API transacation LstTrgVal is used for migration, list records with index 20 in dB EXTXRF
//
// 2.0        210214  Changed to dB EXTXRE    Susanna Kellander
//
public class LstTrgVal extends ExtendM3Transaction {
  private final MIAPI mi; 
  private final DatabaseAPI database; 
  private final ProgramAPI program;
  
  // Constructor 
  public LstTrgVal(MIAPI mi, DatabaseAPI database,ProgramAPI program) {
     this.mi = mi;
  ...
  public void main() { 
    ...
    // List record via target qualifier  
    LstRecord()
  }
  ...
  void LstRecord(){ 
     ...
     DBAction action = database.table("EXTXRE").index("20").selectAllFields().build()
     ...
     // Read with 3 or 4 keys depending on input  
