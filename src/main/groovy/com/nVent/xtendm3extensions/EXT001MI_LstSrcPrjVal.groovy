...
//
// Description 
// This API transacation LstSrcPrjVal is used for migration, list records with index 00 in dB EXTXRF
//
// 2.0        210214  Changed to dB EXTXRE    Susanna Kellander
//
public class LstSrcPrjVal extends ExtendM3Transaction {
  private final MIAPI mi; 
  private final DatabaseAPI database; 
  private final ProgramAPI program;
  
  // Constructor 
  public LstSrcPrjVal(MIAPI mi, DatabaseAPI database,ProgramAPI program) {
     this.mi = mi;
