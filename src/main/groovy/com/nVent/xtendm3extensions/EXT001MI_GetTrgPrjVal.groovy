...
//
// Description 
// This API transacation GetTrgPrjVal is used for migration, get records with index 10 in dB EXTXRF
//
// 2.0        210214  Changed to dB EXTXRE    Susanna Kellander
//

public class GetTrgPrjVal extends ExtendM3Transaction {
 private final MIAPI mi; 
  private final DatabaseAPI database; 
  private final ProgramAPI program;
  
  public GetTrgPrjVal(MIAPI mi, DatabaseAPI database,ProgramAPI program) {
     this.mi = mi;
  ...
  void GetRecord(){ 
     ...
     // Use index 10, sorted by target key value
